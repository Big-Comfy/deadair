...
A stock Elastic 8.17 cluster with the prebuilt detection package installed (1,274 rules),
scanned in 0.8 seconds:

<p align="center">
  <img alt="deadair scan output: 45 dead detections found" src="docs/assets/demo.gif" width="860">
</p>

All 45 are enabled prebuilt rules whose index patterns match nothing in the cluster —
scheduled, executing, green in rule monitoring, and blind. One of them is the Elastic Defend
promotion rule most environments assume is on. Sample reports in every format are in
